        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            <div className="space-y-6">
              <h1 className="text-5xl md:text-7xl font-display text-slate-900 dark:text-white tracking-tight leading-tight">
                Hi, I&apos;m <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">
                  Jerame Matugas
                </span>
              </h1>
              <div className="text-2xl md:text-4xl font-headline text-slate-600 dark:text-slate-400 h-16 tracking-tight">
                <span>{text}</span>
                <span className="animate-pulse text-blue-600 dark:text-blue-400">|</span>
              </div>
            </div>

            <p className="text-xl text-body text-slate-600 dark:text-slate-400 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative">
              {/* Glow Effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 via-purple-600/20 to-pink-600/20 dark:from-blue-400/20 dark:via-purple-400/20 dark:to-pink-400/20 rounded-3xl blur-3xl"></div>
              
              {/* Image Container */}
              <div className="relative w-80 h-96 md:w-96 md:h-[28rem] rounded-3xl overflow-hidden shadow-2xl border-4 border-white dark:border-slate-800">
                <Image
                  src="/profile.jpg"
                  alt="Jerame Matugas"
                  fill
